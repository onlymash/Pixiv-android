...
class UserFollowAdapter(private val mBooksInfo: List<SearchUserResponse.UserPreviewsBean>,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder =
            ContentViewHolder(mLayoutInflater.inflate(R.layout.user_follow_item, parent, false))

    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        (holder as ContentViewHolder).itemView.user_name.text = mBooksInfo[position].user.name
    ...
    override fun getItemCount(): Int = mBooksInfo.size
