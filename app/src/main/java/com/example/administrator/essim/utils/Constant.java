...
public class Constant {
    ...
    public static final String[] donaterList = new String[]{"@阳厨啦", "@太原古交", "@黄鹏飞", "@魏浩杰", "@海洋", "@陈硕",
            ...
            "@此号三秒后删除", "@桃花煮雨", "@不灭", "@空AE白", "@f3rab", "@琦", "@老L", "@这名字特别帅", "@占秋",
            "@军师祭酒", "@乾翔", "@墨迹绿", "@YQiqn执念", "@葱头ing", "@彭小楠", "@不问归期", "@Aimer",
            "@何乞", "@今越", "@澤_澤称奇", "@*希业", "@*鑫陶", "@*项昕", "@*思进", "@*剑", "@*梓洋","@*国庆",
            "@*森", "@*锦仪", "@*提", "@*炜", "@*天径", "@无人的小镇丶", "@*俊鹏", "@*贤齐", "@冯耀卓","@*易杰",
            "@*成", "@*坤铎", "@*嘉明", "@*杰", "@*琳华", "@*柏健", "@*文豪", "@*虹宇", "@*朴",
            "@*恒", "@*秀丽", "@*艺佳", "@*仲苓", "@*炳伟", "@*浩岚","@*富强", "@*佳鑫", "@*汉彬", "@*改梅", "@*梦雄", "@*嘉榆",
            "@*帅锋", "@*明亮", "@*沛然", "@*超", "@*文", "@*星宇","沛烨"};
}
